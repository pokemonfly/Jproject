...
export default class EditPriceModal extends React.Component {
    ...
    commit = ( ) => {
        ...
        switch ( editType ) {
            case 'pc':
                ...
                commitObj.wordMaxPrice = commitObj.wordMaxPriceScope == 1 ? wordPriceLimit : formObj.wordMaxPrice;
                break;
            case 'mobile' : commitObj.mobileWordMaxPrice = formObj.mobileWordMaxPrice;
    ...
    renderContent( ) {
        ...
        return (
            <Form>
                {editType == 'pc' && getFieldDecorator('wordMaxPriceScope', { initialValue: wordMaxPriceScope })(
                ...
                {editType == 'mobileDiscount' && getFieldDecorator('mobileDiscountType', { initialValue: mobileDiscountType })(
                    <Radio.Group>
                        <Form.Item>
                            <Radio value={1}>
