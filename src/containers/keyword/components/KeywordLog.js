...
export default class KeywordLog extends React.Component {
    ...
    getTableCols() {
        ...
        return [
            {
                title: ( <Select defaultValue="-1" onChange={this.setFilter.bind( this, 'logType' )}>
                ...
                title: ( <Select defaultValue="1" onChange={this.setFilter.bind( this, 'logDateType' )}>
                    <Option value='0'>最近7天</Option>
                    <Option value='1'>最近30天</Option>
                    {this.state.isCsMode && ( <Option value='2'>最近90天</Option> )}
                </Select> ),
                width: 165,
                dataIndex: 'operationDate'
            }, {
                title: ( <Select defaultValue="-1" onChange={this.setFilter.bind( this, 'operationType' )} className="select">
                ...
                title: ( <Select defaultValue="-1" onChange={this.setFilter.bind( this, 'operator' )} className="select">
    ...
    render() {
        ...
        return ( <Layout className="keyword-log">
            <Table ref={( table ) => {
                    this.table = table;
                }} dataSource={data} columns={this.getTableCols()}></Table>
            {
                !!data.length && ( <div className="page-container">
