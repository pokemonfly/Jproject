...
@connect( state => ( { query: state.location.query, sellwordsList: state.keyword.adgroup.sellwordsList, onlyGenerate: state.keyword.adgroup.onlyGenerate } ), dispatch => ( bindActionCreators( {
    fetchSellwords,
    putSellwords
...
export default class EditSellwords extends React.Component {
    ...
    render() {
        ...
        return ( <div className="edit-sellwords">
            <Alert message={hint} showIcon="showIcon" type="warning"/>
