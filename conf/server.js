...
if ( config.env === 'development' ) {
    ...
    debug( 'Server is being run outside of live development mode, meaning it will only serve the compiled application bundle in ~/dist. Generally you do' +
            ' not need an application server for this and can instead use a web server such as nginx to serve your static files. See the "deployment" sec' +
            'tion in the README for more information on deployment strategies.' )
